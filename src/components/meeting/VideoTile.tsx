...
export default function VideoTile({
  ...
  const showAvatar = peer.isCameraOff || !peer.stream
  ...
  return (
    ...
    >
      ...
      {showAvatar && (
        <div className="absolute inset-0 flex items-center justify-center bg-zinc-800 dark:bg-zinc-900">
          {peer.avatar ? (
      ...
      {/* Bottom gradient overlay for name label */}
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-black/70 to-transparent" />

      {/* Name label & indicators at bottom */}
      <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          {peer.isMuted ? (
            ...
            <div className="flex h-6 w-6 items-center justify-center rounded-full bg-zinc-900/60 backdrop-blur-sm">
              <Mic className="h-3.5 w-3.5 text-white" />
              <span className="absolute -mt-4 ml-4 h-1.5 w-1.5 rounded-full bg-emerald-400" />
            </div>
          )}
      ...
      {/* Hover overlay with subtle controls */}
      <motion.div
        initial={{ opacity: 0 }}
        ...
        {showAvatar && (
          <div className="flex items-center gap-2 rounded-full bg-black/40 px-3 py-1.5 backdrop-blur-sm">
            ...
            >
              ...
              <path d="M15.6 8.4h3.8" />
              <path d="m17 7 1.5 1.5L17 10" />
              <path d="m17 10 1.5 1.5L17 13" />
            </svg>
